...
class PrecioPorPeriodoTest {
	...
	public void testGetters() {
		PrecioPorPeriodo periodo = new PrecioPorPeriodo(LocalDate.of(2024, 11, 1), LocalDate.of(2024, 11, 30), 100.0,
				"Promoción Noviembre");
		assertEquals(LocalDate.of(2024, 11, 1), periodo.getFechaInicio());
		assertEquals(LocalDate.of(2024, 11, 30), periodo.getFechaFin());
		assertEquals(100.0, periodo.getPrecioPorDia());
		assertEquals("Promoción Noviembre", periodo.getNombre());
	}
}
